...
teaching.\ :sup:`(n.d.a)` Online conferences have become the ‘new
normal’, providing numerous new challenges and opportunities for medical
education.\ :sup:`(n.d.b)` ‘Choose Psychiatry’ initiatives by the Royal
...
initiatives.\ :sup:`(n.d.c)` However, the other two reflect innovative
...
to choose psychiatry.\ :sup:`(n.d.d)` The first UK psychiatry summer
school took place in 2009, organised by King's College
London.\ :sup:`(n.d.e)` These free-of-charge educational experiences
have since expanded nationally (hosts have included Liverpool, Wessex
and Leeds), ranging from one day to full week programmes.
...
interest and boost recruitment.\ :sup:`(n.d.h)`
...
COVID-19 created a need for online educational learning.\ :sup:`(n.d.b)`
Our survey data showed that the 2020 National Psychiatry Summer School
had a positive impact on attendees’ perceptions of psychiatry as a
career choice, and demonstrated how virtual medical education events can
...
psychiatry.\ :sup:`(n.d.f)` Although these virtual events offer a myriad
of opportunities, such as increasing access for medical students in the
...
that act as a ‘social glue’ in terms of networking.\ :sup:`(n.d.i)`
Events are most likely to encompass hybrid models and discussion remains
on how these can be best utilised within psychiatry, medical education,
