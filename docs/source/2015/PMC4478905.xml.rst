...
mental health problems.\ :sup:`(n.d.b)`

The benefits of a comprehensive liaison psychiatry service for a general
hospital fall into four key domains::sup:`(n.d.c)`
...
reattendance and readmission.\ :sup:`(n.d.d)` A subsequent economic
analysis of a 24-hour liaison psychiatry service found that it generated
considerable cost savings for the health economy, with a cost–benefit
ratio of 4:1.\ :sup:`(n.d.e)` The greatest cost benefit was found in
...
wards.\ :sup:`(n.d.f)` In addition, the need for specific liaison
psychiatry service provision for older adults has been
emphasised.\ :sup:`(n.d.g),(n.d.h)`
...
the Royal College of Psychiatrists\ :sup:`(n.d.i)` updated its
recommendations for the staffing of liaison psychiatry services (`Table
1 <#T1>`__). These were reiterated in national commissioning
guidelines.\ :sup:`(n.d.a)` The need for this guidance arose, in part,
from the recognition of the wide variability in service provision.
...
hours and patient groups seen.\ :sup:`(n.d.j)` Although half of services
...
identified in other areas of the UK.\ :sup:`(n.d.k)–(n.d.l)`
...
staffing recommendations\ :sup:`(n.d.i),`\ `a <#TFN1>`__\ RoleWhole time
...
be compared at 27 sites.\ :sup:`(n.d.j)` Data from the two surveys were
...
sizes.\ :sup:`(n.d.m)` The criterion for statistical significance was
set at *P*\ <0.05.
...
surveys of other areas of the UK.\ :sup:`(n.d.k)–(n.d.l)` As service
provision in London has previously been found to be more extensive than
elsewhere, this survey indicates that considerable development is
required across the UK to fulfil national recommendations and achieve
potential cost savings for the wider health economy.\ :sup:`(n.d.e)`
...
survey.\ :sup:`(n.d.g)` Subsequent evidence of their cost-effectiveness
may provide further impetus for the growth of such
services.\ :sup:`(n.d.e)`
...
psychiatry can bring to the management of complex cases.\ :sup:`(n.d.n)`
...
medically unexplained symptoms.\ :sup:`(n.d.n),(n.d.o)`
...
Mandate.\ :sup:`(n.d.p)` NHS England’s objective is to close the health
...
currently paid for from a mental health block contract.\ :sup:`(n.d.r)`
Separate funding of physical and mental health services is inappropriate
for liaison psychiatry, which bridges the two areas.\ :sup:`(n.d.c)`
Work is underway to devise a sustainable model of funding that will
provide more incentive for commissioners and providers of healthcare to
establish comprehensive liaison psychiatry services.
