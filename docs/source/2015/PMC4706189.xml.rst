...
training.\ :sup:`(n.d.a)` One of the main aims of the GMC in the area of
...
completion of different stages of training.’\ :sup:`(n.d.a)`” Although
higher specialist training examinations are not explicitly mentioned,
the introduction of a clear means of ensuring that all doctors have been
...
College of Psychiatrists (MRCPsych).\ :sup:`(n.d.b)` Before 2008,
trainees would sit two written papers, an Objective Structured Clinical
...
time and financial pressures.\ :sup:`(n.d.c)` Further disquiet was
caused among trainees in 2011, when it was revealed that the College had
made a financial surplus from examination fees.\ :sup:`(n.d.d)` In
response to trainee concerns, the College has reduced the number of
written papers to two and also cut exam fees.
...
before most current psychiatric trainees were born,
Kendell\ :sup:`(n.d.e)` wrote of his disapproval regarding the possible
introduction of an exit examination at a time of major changes in the
structure of postgraduate medical education in the UK. Kendell
identified potential problems, including likely trainee dissatisfaction
and the implications for recruitment into psychiatry. He expressed
particular concern about the possible outcomes for those trainees who
were unsuccessful in such exit examinations.

In the early 1990s, after the publication of the Calman
report,\ :sup:`(n.d.f)` both the then president of the Royal College of
Psychiatrists\ :sup:`(n.d.g)` and the Collegiate Trainees
Committee\ :sup:`(n.d.h)` (the predecessor to the PTC) spoke out
strongly against the possibility of introduction of an exit examination.

Ten years ago, Tyrer & Oyebode\ :sup:`(n.d.i)` discussed the need for
changes to the College membership examinations. They acknowledged that
political and other external factors would continue to have an influence
on how doctors training to be psychiatrists would be assessed,
predicting the likelihood of an exit examination being introduced at
some point in the future. Around that time, major changes to the role
and function of the GMC were proposed following the publication of the
5th report of the Shipman Inquiry\ :sup:`(n.d.j)` and an associated
growing public interest in the training and monitoring of doctors in the
UK. In the intervening decade, there have been a number of reports
highlighting concerns about patient safety and quality of care provided
under the auspices of the National Health
Service.\ :sup:`(n.d.k),(n.d.l)`
...
important to assess towards the end of training.\ :sup:`(n.d.m)` This
may reflect the fact that trainees consider an ‘examination’ to be a
...
piloted Wessex advanced training professionalism
programme.\ :sup:`(n.d.n)`
...
review\ :sup:`(n.d.o)` and its suggestion of broad-based training and
...
reliability of clinical examination.\ :sup:`(n.d.p)`
...
census of the College membership,\ :sup:`(n.d.q)` the distribution of
survey respondents and the census data were broadly similar with respect
to subspecialty, although the relatively small number of responses from
