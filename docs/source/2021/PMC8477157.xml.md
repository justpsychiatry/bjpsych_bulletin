...
# Direct interventions for mental health difficulties in LAC {#sec1-2}
...
Swann and York^13^ refer to this multi-agency intervention as
...
## Predictor variables of outcome (H3 and H4) {#sec3-3}
