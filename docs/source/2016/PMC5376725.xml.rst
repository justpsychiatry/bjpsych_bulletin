...
in this area. Lang *et al* :sup:`(n.d.a)` evaluated a policy change that
...
their findings, with the exception of the study by Molnar *et al*,
:sup:`(n.d.d)` which reported an increase in the frequency of
...
*et al* :sup:`(n.d.d)` study also identified an increase in unauthorised
...
better manage risk and absconding. :sup:`(n.d.d)`
...
:sup:`(n.d.h)` in the presence of administrative and clinical support,
...
outcomes is given by the studies of Bowers *et al*,
:sup:`(n.d.i),(n.d.j)` who trialled anti-absconding interventions in
acute psychiatric wards with positive results, and the study by Nijman,
:sup:`(n.d.k)` who demonstrated a reduction in aggressive incidents
through a systematic focus on aggression alongside an intervention to
reduce aggression. These studies suggest the importance of nursing
practice interventions in addition to any environmental measures for
reducing rates of absconding and aggression.
