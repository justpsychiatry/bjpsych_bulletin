...
:sup:`1` Its use is also costly given that it requires the input of an
...
collating data on the use of section 136, :sup:`2` but figures have only
...
socioeconomic deprivation and diagnostic factors, :sup:`7` the available
...
:sup:`10` Chi-squared statistical tests were used where appropriate. We
...
relation to section 136. :sup:`14` Informal feedback from the two police
...
compared with Norfolk. :sup:`15` However, there are also lower levels of
policing per 1000 of population in Suffolk (3.11 *v.* 3.33). :sup:`15`
...
:sup:`17` We believe that our study provides an evidence base for these
