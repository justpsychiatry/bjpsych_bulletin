...
revolutions in progress. :sup:`(n.d.b)` Thomas Szasz published *The Myth
of Mental Illness* in the same year, depicting psychiatrists (and all
other doctors) as agents of social control. :sup:`(n.d.c)` In 1975 Miloš
Forman's *One Flew over the Cuckoo's Nest* portrayed the excesses of
medicalisation, incarceration and psychosurgery. :sup:`(n.d.d)` A famous
...
attracted the diagnosis of schizophrenia. :sup:`(n.d.e)` This massively
...
:sup:`(n.d.f)` The now discredited and mother-blaming notion of the
...
:sup:`(n.d.l)` she was truly in the eye of the storm. ‘I had to carry
