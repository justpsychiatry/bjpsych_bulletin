...
identifying needs, assessing eligibility and care
planning.\ :sup:`(n.d.d)` Each of these should be viewed not only as a
...
**Box 3** The National Eligibility Threshold (Regulation
2(1)14)\ :sup:`(n.d.h)`
...
the FACS criteria\ :sup:`(n.d.g)` considered the needs of the
individual, they did not consider their whole well-being and how this
fits into their everyday lives, meaning that some service users may not
have completely fitted into the specified categories. The criteria that
the Care Act 2014 looks at focus on the individual in context, so that
the impact on their well-being cannot now be overlooked or misjudged.
