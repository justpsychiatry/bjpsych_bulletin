...
models.\ :sup:`(n.d.a)–(n.d.b)` Most of these schemes have not been
robustly evaluated through clinical and controlled trials. There is
however good evidence to suggest that collaborative chronic care models
foster patient self-management and can improve mental and physical
outcomes for patients with mental health problems.\ :sup:`(n.d.b)`

In England, the introduction of clinical commissioning groups (CCGs) in
2013\ :sup:`(n.d.c)` and the significant public spending savings plan
with annual targets for all National Health Service (NHS) provider
organisations\ :sup:`(n.d.d)` resulted in a nationwide review of mental
...
Health Without Mental Health*\ :sup:`(n.d.e)` emphasised the need for
...
assessed patients as not suitable; diagnoses and ICD-10\ :sup:`(n.d.f)`
codes, gender, ethnicity, duration of service provided by secondary
care, number of admissions to hospital; number of patients re-referred
to secondary care or readmitted/relapsed analysis of main
...
(Client's Assessment of Treatment Scale\ :sup:`(n.d.g)`) for the new
service from one of the three localities (Newham).
...
According to Department of Health guidance\ :sup:`(n.d.h)` the main
cluster codes on transfer to EPC were: cluster 10–13: 48.9% (11: 19.4%;
12: 21.5%; 13: 7.1%); cluster 4–7: 26.1%. The number of patients
referred back to secondary care due to clinical issues (relapse
concerns) was 237 (City & Hackney *n* = 65, Newham *n* = 124, Tower
Hamlets *n* = 48).
...
their recovery journey.\ :sup:`(n.d.i)` The care pathway development was
...
out-patient clinic’ model,\ :sup:`(n.d.j)` essentially a replacement
model, which does not provide opportunities for enhanced linkage and
face-to-face consultations between the primary care physician and the
psychiatrist.\ :sup:`(n.d.k)` By contrast, the consultation-liaison
collaboration model provides regular face-to-face contact between the
psychiatrist or mental health worker and the GP.\ :sup:`(n.d.l)`
...
growth.\ :sup:`(n.d.m)` More research of innovative and collaborative
schemes for high-quality cost-effective mental healthcare is required,
assessing the impact of working across primary and secondary
care.\ :sup:`(n.d.n)`
...
champions in mental healthcare\ :sup:`(n.d.o)` and to involve patients
as teachers in interprofessional learning as already pointed out by
Lester *et al*\ :sup:`(n.d.p)` in their discussion paper on integrated
primary mental healthcare more than 10 years ago.
...
affordable and acceptable for the population’\ :sup:`(n.d.q)` can be
substantiated.
