...
they are valued and cared for …’.(n.d.a) National Institute for Health
and Care Excellence guidelines(n.d.b) define various levels of
...
as a genuine (not just linguistic alternative) to observation.(n.d.c)
...
nursing observations.(n.d.d)\ :sup:`,`\ (n.d.e) There is a bidirectional
...
disorders worse.(n.d.f) Importantly, sleep duration is negatively
correlated with subsequent length of time in hospital(n.d.g) and is
associated with a range of physical and mental health problems.(n.d.h)
Specifically, sleep deprivation leads to negative changes in the
neuroendocrine, immune and inflammatory systems, as well as
hypertension. Furthermore, evidence from correlational and experimental
studies have demonstrated that reduced sleep has a severe effect on
emotional regulation.(n.d.i) Paradoxically, it would be better to have
one night of continuous sleep deprivation, followed by advancing the
time of sleep over 3 days combined with bright light in the mornings
(called ‘triple chronotherapy’). This resets the circadian rhythm and
can lead to a rapid improvement in risk of suicide and improvement in
mood.(n.d.j)\ :sup:`,`\ (n.d.k)
...
National Confidential Enquiry into Suicide and Homicide(n.d.l) reported
...
to attend to.(n.d.l) I requested a further search from the National
...
under *intermittent* rather than constant observation.(n.d.m) This is
not really surprising. If you were determined to end your life or
self-harm while being observed intermittently, you would choose a time
just after you have been observed and then act. The rate of suicide is
13.7 per 10 000 admissions (0.14%).(n.d.n) Therefore, about two out of
10 000 admissions die at night between 23.00 h and 07.00 h, and these
are overwhelmingly under *intermittent* observation. It is true that
because there are no randomised controlled trials (RCTs) we do not know
how many deaths were prevented (or delayed) by intermittent
observations. Owing to of the very low rate of suicide at night (two per
10 000 admissions), there will never be a RCT of, say, intermittent *v.*
general observations at night with mortality as the primary outcome,
because the numbers required would be about 250 000 to demonstrate
non-inferiority between two groups.
...
over the following days by causing sleep deprivation.(n.d.o)
...
psychiatric in-patients.(n.d.p) In brief, there is an overwhelming
number of false positives from those rated as having a high risk and
just as many suicides from those rated as a low or medium risk. This is
...
right’.(n.d.a) Last, I would like sleep on an in-patient ward to be
taken seriously, and the principles of sleep hygiene and
cognitive–behavioural therapy for insomnia, adapted for a psychiatric
ward, to be implemented.(n.d.q) This means focusing the culture and
