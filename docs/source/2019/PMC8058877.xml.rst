...
experience for the psychiatrists involved.\ :sup:`(n.d.a)` A paper by
Gibbons and colleagues in this issue\ :sup:`(n.d.b)` describes the
findings from a survey of psychiatrists about their experiences of
patient suicide and serves as a useful reminder of the importance of
this aspect of psychiatric practice; at the same time the results raise
a number of questions about the specifics that lie behind these
apparently self-evident truths.
...
death;\ :sup:`(n.d.c)` the survey reported here asked about suicide of a
...
from the present study\ :sup:`(n.d.a)` relates to the number of
respondents who had experience of multiple patient suicides. Is this a
question of age (years of exposure)? Area of work? What difference does
it make? Is this a situation where multiple exposure sensitises or
desensitises? This sort of accumulated experience of patient suicide is
not likely to be picked up by suicide review, where the focus is on the
patient and their care. Rather, it raises a question about staff review
and how uncommon but important events can be monitored over time.
...
outcomes,\ :sup:`(n.d.d)` raising the question of whether the problem in
...
it is not necessarily bad for our patients if it
leads\ :sup:`(n.d.a),(n.d.e)` to more vigilance and desire for involving
others when managing patients perceived to be at risk of suicide.
...
are vulnerable to the stresses of clinical work.\ :sup:`(n.d.f)`
...
publication,\ :sup:`(n.d.g)` but the effect on professionals is not
covered. The implication is that, as in psychiatry, the expectation is
