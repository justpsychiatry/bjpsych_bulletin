...
## Distribution of CSO hours across patients {#sec2-2}
...
[^4]: Atypical patient was on CSO for the entire 12-month period.
    Category B: serious incident (e.g. attempted hostage taking, serious
    assault, attempted suicide); category C: less serious incident (e.g.
    assault, moderate self-harm, threats); category D: minor incident
    (e.g. verbal abuse, minor self-harm, property damage).
